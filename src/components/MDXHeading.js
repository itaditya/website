...
export default function MDXHeading(props) {
  ...
  const fullAnchorClassName = `inline -ml-8 mr-2 text-xl text-gray-800 opacity-0 group-hover:opacity-100 focus:opacity-100 transition-opacity duration-100 ease-in ${anchorTextLevelMapping[level]}`;
