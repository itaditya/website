  ...
  return (
    <ul className="space-y-4">
      <li className="pl-3 pr-6 md:py-2 rounded-md">
        <Link href="/blog/testing-redux-hooked-app">
          <a className="flex items-start lg:items-center">
            <span
              className="text-2xl rounded-full"
              style={{ color: 'hsl(192.7, 63.5%, 54.9%)' }}
            >
              <IconReact />
            </span>
      ...
      <li className="pl-3 pr-6 md:py-2 rounded-md">
        <Link href="/blog/optimize-your-react-app-with-react-memo">
          <a className="flex items-start lg:items-center">
            <span
              className="mt-2 lg:mt-0 text-2xl rounded-full"
              style={{ color: 'hsl(192.7, 63.5%, 54.9%)' }}
            >
              <IconReact />
            </span>
...
const popularPosts = [
  {
    ...
    title: (
      <Fragment>
        How to escape from async/await
        <br /> hell
      </Fragment>
    ),
  },
  ...
  },
  {
    ...
    title: (
      <Fragment>
        Understanding React Render <br /> Props and HOC
      </Fragment>
    ),
  },
  {
    ...
    title: (
      <Fragment>
        How to Hook Redux in a React <br /> application
      </Fragment>
    ),
  },
];
      ...
      {stateNextArticle && (
        <Link href={'/blog/' + stateNextArticle.slug}>
          <a className="flex flex-col items-center text-center group" data-percy-hidden>
            <span className="text-3xl text-center text-gray-600 md:text-5xl group-hover:text-blue-500">
              <IconChevronRight />
            </span>
            <h3 className="mt-4 text-2xl font-medium text-gray-700 group-hover:text-blue-500 transition">
              Next Up: {stateNextArticle.title}
            </h3>
          </a>
        </Link>
      )}
