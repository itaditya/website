...
const mdxComponents = {
  h1: props => <MDXHeading level={1} className="text-lg leading-tight md:text-5xl" showAnchorLink={false} {...props} />,
  ...
  p: props => <p className="mt-4 text-base text-gray-700 md:text-xl" {...props}></p>,
  a: props => (
    <a
  ...
  ul: props => <ul className="mt-4 ml-8 text-base text-gray-700 list-disc md:text-xl" {...props}></ul>,
  ol: props => <ol className="mt-4 ml-8 text-base text-gray-700 list-decimal md:text-xl" {...props}></ol>,
  ...
  inlineCode: props => (
    <code
      className="px-2 py-1 text-base bg-gray-300 rounded-md"
...
function BlogLayout(props) {
  ...
  return (
    <div
      className="relative min-h-screen py-8 bg-gray-200 px:4 sm:px-24 lg:px-32 xl:px-40 grid grid-cols-12 col-gap-4 font-body"
    ...
    >
      ...
      <main className="py-8 mt-10 col-start-2 col-span-10 xl:col-start-4 xl:col-span-6 row-auto">
        <article>
          <MDXHeading level={1} className="text-3xl leading-tight md:text-5xl" showAnchorLink={false}>
            {meta.title}
          </MDXHeading>
