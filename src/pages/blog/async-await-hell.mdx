...
import IllustrationDescription from '_components/IllustrationDescription';
...
![Cover Photo](https://cdn-media-1.freecodecamp.org/images/1*_3nDjjPTWn4ohLt96IcwCA.png)
<IllustrationDescription>Nesting awaits one after other</IllustrationDescription>
...
If you liked the article, please share this article in your network. If you’d like to get updates, follow me on [Twitter](https://twitter.com/dev__adi). If anything is not clear or you want to point out something, please comment down below.
