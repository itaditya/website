...
export const meta = {
  ...
  readingTime: '5 mins',
  previewPicUrl: 'https://devadi.netlify.app/previews/10-mongo-things-i-wished-i-knew.jpg',
  canonicalUrl: 'https://devadi.netlify.app/blog/10-mongo-things-i-wished-i-knew',
  tags: ['mongodb'],
};
