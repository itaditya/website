...
export const meta = {
  ...
  readingTime: '5 mins',
  previewPicUrl: 'https://devadi.netlify.app/previews/better-components-with-tailwindcss.jpg',
  canonicalUrl: 'https://devadi.netlify.app/blog/better-components-with-tailwindcss',
