...
const mdxComponents = {
  ...
  a: props => <a className="underline text-blue-600 hover:text-blue-700 visited:text-indigo-800" style={{ textDecorationColor: 'currentColor' }} target="_blank" rel="noopener noreferrer" {...props}></a>,
  ...
  code: CodeBlock,
  inlineCode: props => <code className="bg-gray-300 rounded-md py-1 px-2 text-base" style={{ color: 'hsl(0, 61%, 45.8%)' }} {...props}></code>,
  wrapper: MDXLayout,
};
