...
export const meta = {
  ...
  readingTime: '5 mins',
  previewPicUrl: 'https://deploy-preview-15--devadi.netlify.com/previews/better-components-with-tailwindcss.jpg',
  canonicalUrl: 'https://devadi.netlify.com/blog/better-components-with-tailwindcss',
