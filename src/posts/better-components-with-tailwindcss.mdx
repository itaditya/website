...
export const meta = {
  ...
  date: '2019-05-22T00:12:00.000Z',
  description: 'TailwindCSS is great but humans are not.',
  readingTime: '5 mins',
};
...
I hope this article helped you see beyond some advantages of Tailwind. If you liked the article, please <TwitterShare meta={meta} /> and in your network. My [DM](https://twitter.com/messages/1650129775-1650129775?recipient_id=1650129775&text=Hey!) is open if you need to ask anything.
