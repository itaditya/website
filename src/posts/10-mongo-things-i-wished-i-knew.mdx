...
export const meta = {
  ...
  readingTime: '5 mins',
  previewPicUrl: 'https://deploy-preview-15--devadi.netlify.com/previews/10-mongo-things-i-wished-i-knew.jpg',
  canonicalUrl: 'https://devadi.netlify.com/blog/10-mongo-things-i-wished-i-knew',
  tags: ['mongodb'],
};
